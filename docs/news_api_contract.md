...
서버 쪽 구현은 자매 저장소 fmk-f1-calendar 에 있다: 수집기
`scripts/news-rss-collector.ts` + 엔드포인트 `app/api/news/route.ts`
(Next.js) — [news_rss_collector.md](news_rss_collector.md) 참고.
