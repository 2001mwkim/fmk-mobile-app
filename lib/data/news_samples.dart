...
/// 서버 API(`/api/news?limit=20&lang=ko`) 완성 전까지 소식 탭에 보여줄
/// 로컬 샘플 데이터. 발행 시각은 [now] 기준 상대 시간으로 만들어
/// '2시간 전' 같은 표시가 데모에서 자연스럽게 보이게 한다.
///
/// 실서버 연동 시 이 파일은 삭제하고 [SampleNewsRepository]만 교체하면 된다.
